  ...
  return (
    <section className="about" id="about">
      <div className="container">
        ...
        <h2 className="section-title">À propos d'EvalPrx</h2>
        <div className="divider"></div>
        <div className="about-grid">
          <div className="about-text">
            <p>EvalPrx est un <strong>Cabinet d'Étude, de Conseils et de Formation</strong> qui travaille exclusivement dans le Suivi-Évaluation de projets/programmes et le renforcement de capacités dans le domaine.</p>
